...
function createLightThemeAdaptedPalette(): typeof extendedPalette {
  ...
  return {
    ...
    border: {
      ...
      panel: '#e1e4e8' as Hex,         // Границы панелей
    },

    // Обновляем интерактивные элементы
    interactive: {
      ...extendedPalette.interactive,
      button: {
        ...extendedPalette.interactive.button,
        primary: '#0969da' as Hex,     // Синий для основных кнопок
        secondary: '#f1f3f4' as Hex,   // Светлый для вторичных кнопок
      },
      link: '#0969da' as Hex,          // Синий для ссылок
      focus: '#0969da1a' as Hex,       // Прозрачный синий для фокуса
    },
    ...
    git: {
      ...
      conflicted: '#f85149' as Hex,    // Ярко-красный
    },
        terminal: {
