...
const generateInterfaceColors = () => ({
  ...
  'editorIndentGuide.background': interfacePalette.border.default,
  'editorIndentGuide.activeBackground': interfacePalette.border.focus,
  ...
  'statusBarItem.activeBackground': interfacePalette.bg.selection,
  'statusBarItem.hoverBackground': interfacePalette.bg.hover,
  'statusBarItem.prominentBackground': interfacePalette.state.info,
  'statusBarItem.prominentForeground': interfacePalette.bg.base,
  'statusBarItem.prominentHoverBackground': interfacePalette.state.info,
  ...
  // Merge Conflicts
  'merge.currentHeaderBackground': interfacePalette.state.info,
  'merge.currentContentBackground': interfacePalette.state.info,
  'merge.incomingHeaderBackground': interfacePalette.state.success,
  'merge.incomingContentBackground': interfacePalette.state.success,
  'merge.border': interfacePalette.border.default,
  'merge.commonContentBackground': interfacePalette.bg.overlay,
  'merge.commonHeaderBackground': interfacePalette.bg.overlay,
